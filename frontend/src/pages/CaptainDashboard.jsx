    ...
    <Container maxWidth="xl" sx={{ py: 4 }}>
      <Box sx={{ mb: 4 }}>
        ...
        <Typography variant="body1" color="text.secondary">
          Welcome back, {currentUser?.fullname?.firstName || 'Captain'}! Manage your rides and track your earnings.
        </Typography>
      </Box>
        ...
        <Grid item xs={12} md={4}>
          <Card sx={{ borderRadius: 2, height: '100%' }}>
            <CardHeader 
              ...
              avatar={<Avatar sx={{ bgcolor: 'primary.main' }}><AttachMoney /></Avatar>}
            />
            <CardContent>
        ...
        <Grid item xs={12} md={4}>
          <Card sx={{ borderRadius: 2, height: '100%' }}>
            <CardHeader 
              title="This Week" 
              titleTypographyProps={{ variant: 'subtitle1', fontWeight: 'medium' }}
              avatar={<Avatar sx={{ bgcolor: 'secondary.main' }}><Timeline /></Avatar>}
            />
            <CardContent>
              ...
              <Typography variant="body2" color="text.secondary" sx={{ mt: 1 }}>
                {earnings.week > 5000 ? 'Great progress this week!' : 'Keep driving to increase your earnings'}
              </Typography>
            </CardContent>
          </Card>
        </Grid>
        ...
        <Grid item xs={12} md={4}>
          <Card sx={{ borderRadius: 2, height: '100%' }}>
            ...
            <CardContent>
              ...
              <Typography variant="body2" color="text.secondary" sx={{ mt: 1 }}>
                {earnings.month > 30000 ? 'Excellent monthly performance!' : 'You\'re making good progress'}
              </Typography>
            </CardContent>
          </Card>
        </Grid>
              ...
              <Grid container spacing={3}>
                <Grid item xs={6} md={3}>
                  <Box sx={{ textAlign: 'center' }}>
                    ...
                    <Typography variant="h5" fontWeight="bold">{stats.totalRides}</Typography>
                ...
                <Grid item xs={6} md={3}>
                  <Box sx={{ textAlign: 'center' }}>
                    ...
                    <Typography variant="h5" fontWeight="bold">{stats.completionRate}%</Typography>
                ...
                <Grid item xs={6} md={3}>
                  <Box sx={{ textAlign: 'center' }}>
                    ...
                    <Typography variant="h5" fontWeight="bold">{stats.rating}</Typography>
                ...
                <Grid item xs={6} md={3}>
                  <Box sx={{ textAlign: 'center' }}>
                    ...
                    <Typography variant="h5" fontWeight="bold">{stats.cancelRate}%</Typography>
